...
#   --task_data_config_path data_provider/data_config/main_result/nlnempVib_pretrain.yaml\
#   --min_keep_ratio 0.1 \
#   --ddp True\
#   # --device 'cuda:0'
...
python run_pretrain.py \
  ...
  --warmup_epochs 0 \
  --wandb_debug $wandb_mode \
  --pretrain_data_config_path data_provider/data_config/main_result/nlnempVib_pretrain.yaml\
  --device 'cuda:0' \
  --checkpoints './checkpoints_pretrain/nlnVib/' \
  --expert_num 8
